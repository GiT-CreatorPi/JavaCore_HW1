...
public class Cat {
    ...
    private String name;                   // кличка питомца
    private int age;                       // возраст в месяцах
    private String color;                  // окраска
    ...
    Cat(String name, int age, String color, int maxDistanceRun, int maxHeightJump) {
        ...
        this.takePart = true;
        // вывод информации об объекте, а также инкремент количества объектов класса Cat
        if (showObject()) {
            counterObject++;
        }
    }
    ...
    final public boolean showObject() {
        ...
        System.out.println("Создан объект класса \"Cat\"... ");
